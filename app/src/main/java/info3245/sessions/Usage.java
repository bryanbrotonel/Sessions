...
public class Usage extends Container {
    ...
    private static final String[] dataFiles = {Usage_1Day, Usage_3Day, Usage_2Day};
    ...
    private void writeUsageData(String file, String date, int usage, int sessions, int goal) {
        ...
        editor.putInt(Sessions, usage);
        editor.putInt(Usage, sessions);
    ...
    private void updateUsageData() {
        ...
        sharedPref = getApplicationContext().getSharedPreferences(Usage_1Day, Context.MODE_PRIVATE);
